...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(30, 70, 551, 65))
        self.gridLayoutWidget_2.setObjectName("gridLayoutWidget_2")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.gridLayoutWidget_2)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.addqueue_btn = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.addqueue_btn.setObjectName("addqueue")
        self.gridLayout_2.addWidget(self.addqueue_btn, 0, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.download_btn, 1, 2, 1, 1)
        self.lineEdit = QtWidgets.QLineEdit(self.gridLayoutWidget_2)
        self.lineEdit.setObjectName("lineEdit")
        self.gridLayout_2.addWidget(self.lineEdit, 0, 0, 2, 1)
